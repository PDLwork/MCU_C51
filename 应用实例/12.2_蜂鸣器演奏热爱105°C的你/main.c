...
{  
	...
	P , 4,				M3, 2, M3, 2,		M4, 2, M3, 2,		M2, 2, M3, 2,
	L6, 4,				M2, 2, M1, 2,		L6, 4,				M1, 4,
	M2, 4,				M2, 2, M2, 2,		M2, 2, M2, 2,		M1, 2, M2, 2,
	M3, 4,				M1, 2, L6, 2,		L6, 2, 0xFE, M1, 2,	L6, 2, 0xFE, M1, 2,
	L6, 4,				M3, 2, M3, 2,		M3, 2, M3, 2,		M2, 2, M1, 2,
	
	M3, 2, 0xFE,		M2, 4, M3, 2,		L6, 4,				L6, 2, M1, 2,
	M1, 2, 0xFE, L7, 2, L7, 2, L7, 2,		M3, 4,				M2, 4,
	M1, 4+4+4+4,
...
void main(void)
{
	...
	while(1)
	{
		...
		Music_Seclect++;
		if(Music[Music_Seclect] != 0xFE)	//关闭中断并延时达到松手效果
		{
			TR0 = 0;
			DelayXms(5);
			TR0 = 1;
